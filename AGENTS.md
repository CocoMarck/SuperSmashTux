...
4. **NUNCA HAGAS COMMITS NI CAMBIOS DE GIT POR TU CUENTA.** Nada de `commit`, `push`, `checkout`, crear ramas, etc. de forma autónoma. Solo cuando el dev lo pida explícitamente para esa acción puntual.
